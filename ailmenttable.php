...
$query="SELECT * FROM ailmentrecords";
...
<body>
<h2 style= "text-align:center">AILMENT RECORDS</h2>   
<a href="ailment.php">  <button class="button-3" role="button">
  CREATE
</button></a>
