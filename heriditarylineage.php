...
<body>
<h2 style= "text-align:center">HEREDITARY INFORMATION</h2>   
...
<tr>
            ...
            <td><a href="updatehereditary.php?id=<?php echo $row["offspringid"]; ?>"><button class="button-3" >Update</button></a></td>

            <td><a href="deletehereditary.php?id=<?php echo $row["offspringid"]; ?>"><button class="button-3" >Delete</button></a></td>
