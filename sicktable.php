...
$query="SELECT * FROM livestock WHERE healthstatus='Sick'";
...
<body>
<h2 style= "text-align:center">SICK LIVESTOCK</h2>  
<a href="livestockform.php">  <button class="button-3" role="button">
  CREATE
</button></a>
<a href="healthytable.php">  <button class="button-3" role="button">
  HEALTHY
</button></a>
<a href="sickmale.php">  <button class="button-3" role="button">
  MALE
</button></a>
<a href="sickfemale.php">  <button class="button-3" role="button">
  FEMALE
</button></a>
<a href="healthytable.php">  <button class="button-3" role="button">
  CLOSE
