...
include "database.php";
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE `production` SET `livestockid`='$livestockid',`category`='$category',`milkproduced`='$milkproduced',`daterec`='$daterec' WHERE `productionid`='$productionid'"; 
...
<body>
    ...
    <form method="post" action="" name="productionform" onSubmit="return validate_productionform();">
        ...
        <input type='text' id='productionid' name='productionid' placeholder='ProductionID' class='form-input-size' value="<?php echo $productionid; ?>"  />
        </div></br>
        <div class='form-input'>
        ...
        <div class='form-input'>
            ...
            <input type='number' id='milkproduce' name="milkproduced" placeholder='Enter Milk produced in Ltr' class='form-input-size'value="<?php echo $milkproduced; ?>"  />
        </div></br>
        <div class='form-input'>
            <label id='date-label'>Date recorded</label>
            <input type='text' id='date' placeholder='Enter DOB'name="daterec" class='form-input-size'value="<?php echo $daterec; ?>" />
        </div></br>
        <div class='form-input'>
