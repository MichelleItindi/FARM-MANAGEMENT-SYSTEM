...
$query="SELECT * FROM livestock WHERE category='Pig' AND age>1";
...
<body>
<h2 style= "text-align:center">PIGS READY FOR BREEDING</h2>   
...
<a href="sows.php">  <button class="button-3" role="button">
  SOWS
</button></a>
<a href="boars.php">  <button class="button-3" role="button">
  BOARS
</button></a>
