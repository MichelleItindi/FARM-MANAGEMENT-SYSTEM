...
<body>
<h2 style= "text-align:center">LIVESTOCK INFORMATION</h2>   
<a href="livestockform.php">  <button class="button-3" role="button">
  CREATE
</button></a>

<a href="farmtable.php">  <button class="button-3" role="button">
  FARM INFORMATION
</button></a>
<a href="livestocktable.php">  <button class="button-3" role="button">
  CLOSE
</button></a>

<form action="#" method="POST">
<div class="form-group"><label >Filter By Farm Location</label>
</div>
<div class="form-group">
    <select name="filterChoice" class="form-control" >
<option value="0">Select</option>    
<option value="1">FARM 1:Embu</option>
<option value="2">FARM 2:Thika</option>
<option value="3">FARM 3:Kitui</option>    
<option value="4">FARM 4:Mombasa</option>
<option value="5">FARM 5:Nairobi</option>
    </select>
</div>
...
switch($_POST['filterChoice']){
                                ...
                                case "1":
                                  $sql="SELECT * FROM livestock WHERE farmid='1'"; 
                                  getData($sql);
                                  break;
                                  case "2":
                                    $sql="SELECT * FROM livestock WHERE farmid='2'";
                                    getData($sql);
                                    break;
                                    ;
                                    case "3":
                                        $sql="SELECT * FROM livestock WHERE farmid='3'"; 
                                        getData($sql);
                                        break;
                                        case "4":
                                          $sql="SELECT * FROM livestock WHERE farmid='4'";
                                          getData($sql);
                                          break;
                                          ;
                                          case "5":
                                            $sql="SELECT * FROM livestock WHERE farmid='5'"; 
                                            getData($sql);
                                            break;
