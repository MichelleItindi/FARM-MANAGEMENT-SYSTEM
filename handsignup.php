...
//form input stored in variables when signup button is clicked
...
//If the user exists then send a warning
if (mysqli_num_rows($checkquery) == 1){ 
  echo '<script>alert("This user already exists")</script>';
}
//If the user doesnt exist then input the data into the database
  else{
...
<div class="signup-page">
  <div class="form">
    <form class="login-form" method="post" action="" name="handsignup" onSubmit="return validate_handsignup();"  >
      ...
      <p class="message">Have you registered before? <a href="handlogin.php">Login here</a></p>
    </form>
  </div>
</div>
<script>
