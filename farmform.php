...
if(isset($_POST["submit"])){
    ...
    $farm= mysqli_query($conn,"INSERT INTO farm(farmid,farmname,address,description) VALUES ('$farmid','$farmname','$address','$description')");
...
<body>
    ...
    <form method="POST" action="" name="farmform" onSubmit="return validate_farmform();">
        ...
        <div class='form-input'>
            ...
            <input type='text' id='farmname' name="farmname" placeholder='Enter Farm name' class='form-input-size' />
        </div></br>      
        <div class='form-input'>
            <label id='name-label'>Address</label>
            <input type='text' id='address' name="address" placeholder='Enter address' class='form-input-size' />
        </div></br>
        <div class='form-input'>
            <label id='name-label'>Description</label>
            <input type='text' id='description' name="description" placeholder='Description' class='form-input-size' />
        </div></br>
