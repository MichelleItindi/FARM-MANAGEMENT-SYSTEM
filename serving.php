...
if(isset($_POST["submit"])){
    ...
    $offspring= mysqli_query($conn,"INSERT INTO serving(sowid,date,methodology,buckid,outcome,outcomedates,piglets) VALUES ('$sowid','$date','$methodology','$buckid','$outcome','$outomedates','$piglets')");
    if($offspring==true){
...
<body>
    ...
    <form method="post" action="" >
        <div class='form-input'>
            ...
            <input type='text' id='sowid' name='sowid' placeholder='Enter Sow ID' class='form-input-size'  />
        </div> </br>
        <div class='form-input'>
            <label id='name-label'>Date</label>
            <input type='text' id='date' name='date' placeholder='sowid' class='form-input-size'  />
        </div> </br>
        <div class='form-input'>
            <label id='name-label'>Methodology</label>
            <input type='text' id='methodology' name="methodology" placeholder='Enter Batch number' class='form-input-size' />
        </div></br>
        <div class='form-input'>
            <label id='name-label'>Buck ID</label>
            <input type='text' id='buckid' name="buckid" placeholder='Enter Buck ID' class='form-input-size' />
        </div></br>
        <div class='form-input'>
            <label id='name-label'>Outcome</label>
            <input type='text' id='outcome' name="outcome" placeholder='Enter Father ID' class='form-input-size' />
        </div></br>
        
         <div class='form-input'>
            <label id='date-label'>Date served</label>
            <input type='date' id='date' placeholder='Enter DOB'name="date" class='form-input-size'/>
        </div></br>
        <div class='form-input'>
            <label id='name-label'>Piglets</label>
            <input type='number' id='piglets' name="piglets" placeholder='Enter piglets born' class='form-input-size' />
        </div></br>
        <div class='form-input'>
