...
<body>
<h2 style= "text-align:center">MEDICATION RECORDS</h2> 
<a href="medication.php">  <button class="button-3" role="button">
  CREATE
</button></a>
   ...
   if(mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <td><?php echo $row['treatmentreason']; ?></td> 
            <td><?php echo $row['medicinename']; ?></td> 
            <td><?php echo $row['livestockid']; ?></td> 
            <td><?php echo $row['startdate']; ?></td> 
            <td><?php echo $row['enddate']; ?></td> 
            <td><?php echo $row['doseperday']; ?></td> 
            <td><?php echo $row['supplier']; ?></td> 
            <td><?php echo $row['administeredby']; ?></td> 
            <td><?php echo $row['additionalnotes']; ?></td> 
            <td><?php echo $row['vetcontact']; ?></td> 
