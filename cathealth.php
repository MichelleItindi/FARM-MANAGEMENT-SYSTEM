...
<option value="1">Healthy Cattle</option>
<option value="2">Sick Cattle</option>
<option value="3">Healthy Pig</option>    
<option value="4">Sick Pig</option>
<option value="5">Healthy Goat</option>
<option value="6">Sick Goat</option>    
...
switch($_POST['filterChoice']){
                                ...
                                case "1":
                                  $sql="SELECT * FROM livestock WHERE healthstatus='Healthy' AND category='Cattle'"; 
                                  getData($sql);
                                  break;
                                  case "2":
                                    $sql="SELECT * FROM livestock WHERE healthstatus='Sick' AND category='Cattle'";
                                    getData($sql);
                                    break;
                                    ;
                                    case "3":
                                        $sql="SELECT * FROM livestock WHERE healthstatus='Healthy' AND category='Pig'"; 
                                        getData($sql);
                                        break;
                                        case "4":
                                          $sql="SELECT * FROM livestock WHERE healthstatus='Sick' AND category='Pig'";
                                          getData($sql);
                                          break;
                                          ;
                                          case "5":
                                            $sql="SELECT * FROM livestock WHERE healthstatus='Healthy' AND category='Goat'"; 
                                            getData($sql);
                                            break;
                                            case "6":
                                              $sql="SELECT * FROM livestock WHERE healthstatus='Sick' AND category='Goat'";
                                              getData($sql);
                                              break;
                                              ;       
