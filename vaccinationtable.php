...
$query="SELECT * FROM vaccinationrecords";
...
<a href="vaccination.php">  <button class="button-3" role="button">
  CREATE
</button></a>
<a href="vaccinationtable.php">  <button class="button-3" role="button">
  CLOSE</button></a>
