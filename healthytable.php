...
$query="SELECT * FROM livestock WHERE healthstatus='Healthy'";
...
<body>
<h2 style= "text-align:center">HEALTHY LIVESTOCK</h2>  
<a href="livestockform.php">  <button class="button-3" role="button">
  CREATE
</button></a>
<a href="sicktable.php">  <button class="button-3" role="button">
  SICK
</button></a>
<a href="healthymale.php">  <button class="button-3" role="button">
  MALE
</button></a>
<a href="healthyfemale.php">  <button class="button-3" role="button">
  FEMALE
</button></a>
